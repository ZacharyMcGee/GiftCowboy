<?php
   ...
   $sql = "select gifts.url, gifts.id, gifts.title, gifts.price, gifts.image, gifts.description, giftid, count(giftid) from favorited inner join gifts on favorited.giftid = gifts.id group by giftid order by count(giftid) asc";
